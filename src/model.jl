...
function (fc::ChainStormV1)(t, Xt, aas, chainids, resinds, disto_gram, temps; sc_frames = nothing)
    l = fc.layers
    temps = 2f-3 .* temps
    ...
    cond = reshape(l.cond_t_encoding(t_rff)+l.cond_temp_encoding(temp_rff), :, 1, size(t,2))
